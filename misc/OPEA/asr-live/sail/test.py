...
from sail.proto import (COMPRESSION_GZIP, COMPRESSION_NONE, ERR_INVALID_PARAM,
                        ERR_SUCCESS, FLAG_LAST_AUDIO, FLAG_LAST_RESPONSE,
                        FLAG_NORMAL, HEADER_SIZE_VALUE, MSG_AUDIO_ONLY_REQUEST,
                        MSG_ERROR_RESPONSE, MSG_FULL_CLIENT_REQUEST,
                        MSG_FULL_SERVER_RESPONSE, PROTOCOL_VERSION,
                        SERIALIZATION_JSON, SERIALIZATION_NONE,
                        AudioOnlyRequest, BaseMessage, ErrorResponse,
                        FullClientRequest, FullServerResponse, Header,
                        SAILProtocolHandler)
...
class TestProtocolHandler(unittest.TestCase):
    ...
    def test_serialize_messages(self):
        ...
        error_resp = ErrorResponse(
            error_header, ERR_INVALID_PARAM, {"message": "Error"}
        )
